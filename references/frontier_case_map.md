...
| Kannan–Bayraksan–Luedtke Residuals-Based DRO | Regression prediction + empirical residual ambiguity + conditional optimization | Separate regression error from residual-distribution error; distinguish covariate and response dimensions |
...
| Gao Finite-Sample WDRO | Variation-based concentration + loss-class complexity + Wasserstein regularization | Distinguish loss-level root-sample guarantees from full-distribution Wasserstein containment |
